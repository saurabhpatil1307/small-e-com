...
const Rating = ({ rate, count }) => {
  // Calculate full and half stars based on rate
  ...
  return (
    <div className="flex items-center flex-wrap">
      ...
      <p className="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400">{rate.toFixed(1)}</p>
      <p className="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400">out of</p>
      <p className="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400">5</p>
      <p className="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400">({count} reviews)</p>
    </div>
  );
};
